...
import { FaSignOutAlt, FaCog, FaBars, FaMoon, FaSun, FaCrown } from "react-icons/fa";
    ...
    <nav className="navbar navbar-dark sticky-top premium-nav-dark px-2 px-md-4">
      <div className="container-fluid d-flex align-items-center justify-content-between p-0">
        ...
        <div className="d-flex align-items-center gap-2 gap-md-3">
          ...
          <div className="nav-brand-box" onClick={() => navigate("/admin/dashboard")} style={{ cursor: "pointer" }}>
            {settings?.logo && (
...
<img
  ...
  onError={(e) => {
    e.currentTarget.onerror = null; // ✅ Ye line infinite loop ko rok degi
    e.currentTarget.src = `https://ui-avatars.com/api/?name=User&background=ccc&color=fff`; 
  }}
/>
            </Dropdown.Toggle>
