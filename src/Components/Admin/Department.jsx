...
import "./Department.css"; // Import the scoped CSS

// Icons
import { FcDepartment } from "react-icons/fc";
import { BiSearch, BiBuildingHouse, BiEdit, BiTrash, BiFilter, BiPlus, BiReset } from "react-icons/bi";
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="d-flex">
                ...
                <button type="submit" className="btn-primary">
                  {editId ? "Update Changes" : "Create Department"}
                </button>
              </div>
            </form>
          </div>
                ...
                <table className="custom-table">
                  ...
                  <tbody>
                    {filteredData.length === 0 ? (
                      <tr>
                        <td colSpan="5" className="text-center py-5" style={{color: 'var(--text-secondary)'}}>
                      ...
                      filteredData.map((d, i) => (
                        <tr key={d._id}>
                          ...
                          <td>
                            <span className="dept-branch-tag">
                               <BiBuildingHouse /> {d.branchId?.name || "N/A"}
                            </span>
                          </td>
                          <td style={{maxWidth:'250px', whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis', color:'var(--text-secondary)'}}>
                            {d.description}
                          </td>
                          <td>
